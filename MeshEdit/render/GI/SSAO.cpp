...
SSAO::~SSAO()
    ...
    void SSAO::render(std::vector<MeshBase*>meshList, Camera& cam, Shader* pRenderShader)
    {
    ...
    void SSAO::renderLight(Camera& cam, Shader* pRenderShader)
    {
        pRenderShader->use();
    ...
    void SSAO::CreatSSAOFrameBuffer()
    {
    ...
    // SSAO four pass
    void SSAO::GeometryPass(std::vector<MeshBase*>meshList, Camera& cam)
    {
    ...
    void SSAO::SSAOTexturePass(Camera& cam)
    {
        glBindFramebuffer(GL_FRAMEBUFFER, ssaoFBO);
        glClear(GL_COLOR_BUFFER_BIT);
